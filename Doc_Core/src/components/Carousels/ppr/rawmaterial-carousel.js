...
const imagesRawMaterial = createImageArray (
    url1, url2, url4, url5 
);

const captionsRawMaterial = createCaptionArray(
...
export function RawMaterialCarousel() {
    return (
        <>
            <ImgCarousel images={imagesRawMaterial} captions={captionsRawMaterial}/>            
        </>
    )
}
//============================================================================
